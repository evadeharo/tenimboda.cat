    ...
    <Grid className="py-[3rem] lg:py-[3.75rem] min-h-[100dvh] bg-yellow">
      ...
      <div className="col-span-4 lg:col-span-full flex items-end order-3">
        <div className="flex flex-col w-max">
          <h1 className="text-title-xl-mobile lg:text-title-xl w-2/3 lg:w-full">{translations.orioleva}</h1>
          <h2 className="text-subtitle-mobile lg:text-subtitle">{translations.footer_thanks}</h2>
        </div>
      </div>
    </Grid>
  );
